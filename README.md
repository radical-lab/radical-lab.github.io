...
* [ ] powerboards
* [ ] vegan
	* [ ] headphones: (no plastic; gloves + habanero = headphone microplastics are insignificant), wired, noise cancelling, over ear,.. (headset straps pull the phones together, but i need to find soft ear hooks)
...
some /stars|galaxies|universes|lights|masses/ are missing, and some are fake; some stars are /(holo)?(wav|phas)ed/ /in|out/ #dark_matter
probing the dark /stars|galaxies|universes|lights|masses/ is an alien test; babylon 5 inverted
...
/tectonics|(lunar|earthly) wibbly wobbly wobblez/ could influence the /periodicity|frequency|interval notation|maturation|iteration|circumflex|trajectory|(bullet|elemental|planet) bending|orbit/
...
they don't give gambling addicts more money to gamble away; why give any other addicts more addiction? why outlaw addictions for those who are not addicted? addiction is merely an excuse for a habit taken too far; too much of any"-thing" is a bad habit detrimental to health, the environment, and every"-thing"
otherwise we should all get free money (specifically for gambling); except for mental disabilities that claim they /aren't addicted|don't gamble/, comatose smegheads who can't gamble (until two way bci supports their gambling habits),..
addictions ≠ allergies
neuroplasticity, phenotypic plasticity,..
...
it's nice to know copbots will only target uncanny valley white people; considering the rest of us adversarial apes (we won't be considered evolved ∵ apes can already hack, drive, act, deafly communicate,.; universal translators must include signals #babyhandz)
...
how do i detect observation? /vanta (darkness|surfaces)|anechoic chamber|faraday cage|spectr.*|(subatomic)? particle detectors/ for the observer paradox
